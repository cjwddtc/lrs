...
text_panel::text_panel( lsy::port *po, wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : 
	...
	port(po)
{
	...
	Bind(wxEVT_PAINT, [this, parent](auto &a) {if(parent)SetSize(parent->GetSize()); });
	...
	m_button1 = new wxButton( this, wxID_ANY, wxT("发送"), wxDefaultPosition, wxDefaultSize, 0 );
