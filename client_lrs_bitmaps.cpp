...
void wxCBFE8InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/client_lrs_bitmaps.cpp$I__lrs_client_lrs_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/client_lrs_bitmaps.cpp$I__lrs_client_lrs_bitmaps.xrc"));
}
