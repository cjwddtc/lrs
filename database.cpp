...
const_blob::const_blob(const void *ptr_, size_t size_):ptr(ptr_),size(size_)
{
}
...
database::statement::statement(database *db, std::string sql):io(db->io)
{
...
database::statement::proxy::proxy(sqlite3_value *value_) : value(value_) 
{
}
