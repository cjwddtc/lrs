...
void wxCD640InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/player_list_lrs_bitmaps.cpp$I__lrs_player_list_lrs_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/player_list_lrs_bitmaps.cpp$I__lrs_player_list_lrs_bitmaps.xrc"));
}
