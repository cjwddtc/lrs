...
int main()
{
    ...
    plc.div("<><weight=80% vertical<><weight=70% vertical <vertical gap=10 textboxs arrange=[25,25,25]>  <weight=25 gap=10 buttons> ><>><>");
    ...
    cancel.events().click([&li](){li.close();API::exit();});
